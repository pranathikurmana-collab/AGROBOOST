...
<aside class="sidebar">
    ...
    <nav class="nav">
        ...
        <span class="nav-label" style="margin-top:1rem">Customer Portal</span>
        <a href="shop.html" class="nav-item">🛒 Marketplace</a>
        <a href="payments.html" class="nav-item">Payments</a>
        
        <span class="nav-label" style="margin-top:1rem">Records</span>
        <a href="records.html" class="nav-item">All Records</a>
    </nav>
